...
export const DataTableCheckbox = ({ fullCheck, partialCheck, ...rest}: Props) => {

	let color = 'bg-white text-white'
	if(fullCheck) color = 'bg-slate-700 text-white'
	if(partialCheck) color = 'bg-white text-slate-800'
