...
const ContactUs = () => {
	...
	return (
		<div className=''>
			...
			<div data-name="talk-with-us-container" className=" 
				grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 mt-8 p-4 md:p-8
				">
				<div data-name="talk-with-us" className="col-span-12 md:col-span-7 
				flex flex-col
				">
					<h1 className="text-red-600/80 text-4xl font-extrabold mb-4">Let's talk with us</h1>
