...
const Portfolio = async () => {
	const { status, message, data: portfolios } = await actionApiRequest<PortfolioDocument[]>('/api/portfolios')
	...
	return (
		<>
			...
			<div className="p-2 md:px-20">
				<div data-name="hero-content-container" className="mt-20 bg-white ">
							...
							{portfolios?.map((portfolio) => (
								...
								">
									<Link href={`/portfolio/${portfolio.slug}`}>
										<Image 
											src={portfolio.coverPhoto.secure_url}
											alt={portfolio.coverPhoto.alt!}
											width={350}
											height={250}
