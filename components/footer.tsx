...
export const Footer = ({ className }: Props) => {
	...
	return (
		<footer className={`${className} mt-6 bg-[#292929]  text-slate-100`}>
			...
			<div className="container mx-auto px-6 md:px-0 grid grid-cols-1 md:grid-cols-3 gap-4">
			...
			<div className="container mx-auto px-6 md:px-0 my-6 flex items-center gap-1 rounded-sm">
